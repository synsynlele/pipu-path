    ...
    >
      ...
      <div>
        ...
        <input
          ...
          className="border-border bg-background mt-2 block w-full rounded-xl border p-3 text-sm file:mr-4 file:rounded-lg file:border-0 file:bg-gold file:px-3 file:py-2 file:font-semibold file:text-[#100f0c]"
        />
      </div>
      <div>
