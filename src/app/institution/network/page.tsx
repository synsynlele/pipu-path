  ...
  return (
    ...
    >
      ...
      <div className="mt-6 flex flex-wrap items-center gap-2">
        ...
        <ButtonLink
          href={`/institution?workspace=${workspace.workspaceId}`}
          variant="ghost"
        >
          Back to Institution
        </ButtonLink>
      ...
      <Surface className="border-gold/25 bg-gold/5 mt-8 p-6 sm:p-8">
        ...
        <p className="text-muted mt-3 max-w-4xl leading-7">
          ...
          Adult Builders are never mixed into the school social scope.
          Cross-school interaction works only when both participating schools
      ...
      <Surface className="mt-8 p-6 sm:p-8">
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div>
            ...
            <h2 className="mt-2 text-2xl font-semibold">
              Set the school boundary.
            </h2>
            <p className="text-muted mt-3 max-w-2xl leading-7">
              These are institutional permissions, not cosmetic settings.
              Turning the main network off withdraws active school
              participation. Private developmental evidence remains outside
              Builder World.
            </p>
          </div>
        ...
        {owner ? (
          <form
            action={setSchoolBuilderNetworkSettingsAction}
          ...
          >
            ...
            <label className="flex items-start gap-3 rounded-2xl border border-slate-200 p-4">
              <input
                type="checkbox"
                name="networkEnabled"
                defaultChecked={settings.networkEnabled}
                className="mt-1"
              />
              <span>
                ...
                <span className="text-muted mt-1 block text-sm leading-6">
                  ...
                  cross-school interaction and direct messaging are also forced
                  off.
                </span>
              </span>
            </label>
            <label className="flex items-start gap-3 rounded-2xl border border-slate-200 p-4">
              <input
                type="checkbox"
                name="crossSchoolEnabled"
                defaultChecked={settings.crossSchoolEnabled}
                className="mt-1"
              />
              <span>
                <strong className="block">
                  Allow cross-school Builder discovery
                </strong>
                <span className="text-muted mt-1 block text-sm leading-6">
                  Students can see compatible school Builders outside this
                  school only when the other school has independently enabled
                  the same policy.
                </span>
              </span>
            </label>
            <label className="flex items-start gap-3 rounded-2xl border border-slate-200 p-4">
              <input
                ...
                defaultChecked={settings.directMessagesEnabled}
                className="mt-1"
              />
              <span>
          ...
          <p className="text-muted mt-6 rounded-2xl border border-slate-200 bg-slate-50 p-4 text-sm leading-6">
            You can view this policy, but only an Institution Workspace owner
            can change School Builder Network permissions.
          </p>
        )}
      </Surface>
    </main>
