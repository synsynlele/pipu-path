          ...
          <section className="pp-app-hero pp-mobile-section mt-5 min-h-[17rem] p-5 sm:p-7">
            <div className="relative z-10 max-w-[68%] min-w-0 sm:max-w-[56%]">
              ...
              <p className="mt-2 line-clamp-3 text-sm leading-6 text-indigo-50/78">
                PipuPath uses your choices, attempts, evidence and reflection.
                It does not reduce you to a fixed AI label.
              </p>
              <ButtonLink
                href={primaryHref}
                variant="light"
        ...
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          ...
          <section className="pp-app-card pp-mobile-section mt-5 p-5 sm:p-6">
            <div className="flex items-start justify-between gap-4">
              ...
              <span className="shrink-0 rounded-full bg-[#dff8f4] px-2.5 py-1 text-[0.68rem] font-bold text-[#119c88]">
                Live
              </span>
            </div>
            <div className="mt-4 rounded-[1.35rem] border border-[#e6e0fa] bg-gradient-to-br from-[#faf8ff] to-[#f2efff] p-4">
              <div className="flex gap-3">
                <span className="grid size-12 shrink-0 place-items-center rounded-full bg-gradient-to-br from-[#7049e8] to-[#df79b3] text-xl text-white">
                  ✦
                </span>
                <div>
                  <p className="text-sm leading-6 font-bold text-[#2a2d4d]">
                    {state.mission?.mission_statement ??
                      state.destination.description}
                  </p>
                  <p className="mt-1 text-xs leading-5 text-[#7d8299]">
                    This evolves from completed Quests, evidence, reflection,
                    Projects and verified capability.
                  </p>
                </div>
              </div>
            </div>
          ...
          <section className="pp-app-card pp-mobile-section mt-4 p-5 sm:p-6">
            <div className="flex items-center justify-between gap-4">
              <div>
                <p className="text-xs font-bold tracking-[0.12em] text-[#13a28d] uppercase">
                  Your direction
                </p>
              ...
              <span className="grid size-12 shrink-0 place-items-center rounded-2xl bg-[#e7f8f5] text-xl text-[#16a28f]">
                ↗
              </span>
            </div>
          ...
          <section className="pp-mobile-section mt-6">
            <div className="flex items-end justify-between gap-3 px-1">
              <div>
                ...
                <p className="mt-1 text-sm text-[#8a90a4]">
            ...
            <div className="pp-stage26-scroll -mx-4 mt-3 flex gap-3 overflow-x-auto px-4 pb-2 sm:mx-0 sm:grid sm:grid-cols-4 sm:px-0">
              <DiscoveryCard
                ...
                detail="See evidence-backed signals."
                icon="◇"
              />
              <DiscoveryCard
                href="/mission"
                title="Direction"
                detail="Revisit the mission you are testing."
                icon="⚑"
              />
              <DiscoveryCard
                href="/growth"
                title="Growth Pack"
                detail="Learn only what helps the next move."
                icon="↗"
              />
              <DiscoveryCard
                href="/guide"
                title="Builder Guide"
                detail="Get private contextual guidance."
                icon="✦"
              />
            </div>
          </section>
...
function DiscoveryCard({
  ...
  return (
    ...
    >
      <span
        className="grid size-11 place-items-center rounded-full bg-gradient-to-br from-[#7358ee] to-[#e479ae] text-base text-white"
        aria-hidden="true"
      >
        {icon}
      </span>
      <h3 className="mt-4 text-sm leading-5 font-bold text-[#25284a]">
        {title}
      </h3>
