...
export default async function HomePage() {
  ...
  return (
    ...
    >
      <section className="from-primary to-primary-light shadow-primary/15 relative overflow-hidden rounded-[2rem] bg-gradient-to-br px-6 py-9 text-white shadow-xl sm:px-10 sm:py-12">
