...
type FeatureKey = "home" | "profile" | "journey" | "build" | "portfolio" | "connect";

function featureForPath(pathname: string): FeatureKey | null {
  if (pathname === "/app") return "home";
  if (pathname.startsWith("/profile") || pathname.startsWith("/onboarding/discovery/profile")) return "profile";
  if (pathname.startsWith("/mission") || pathname.startsWith("/journey")) return "journey";
  if (pathname.startsWith("/build") || pathname.startsWith("/quests") || pathname.startsWith("/projects")) return "build";
